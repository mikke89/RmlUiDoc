...
| `Contains()` | Checks if the target element is a descendant of the current element. | contains()
...
| `Matches()` | Checks if the current element matches the given RCSS selector(s). | matches()
