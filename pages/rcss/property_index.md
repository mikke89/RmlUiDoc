...
`fill-image`{:.prop} | \<string\> | _empty_ | [progressbar's]({{"pages/cpp_manual/controls/progress_bar.html"|relative_url}}) fill element | no | | \<string\> refers to a sprite name or an image url.
